...
E2APControlMessage<T1,T2>::~E2APControlMessage(void){
  ...
  mdclog_write(MDCLOG_DEBUG, "Freeing E2AP Control Message object memory");
  ...
  mdclog_write(MDCLOG_DEBUG, "Freed E2AP Control Message object memory\n");
...
bool E2APControlMessage<T1,T2>::encode(unsigned char *buf, size_t *size){
  ...
  mdclog_write(MDCLOG_DEBUG, "Encoding E2APControlMessage\n");
