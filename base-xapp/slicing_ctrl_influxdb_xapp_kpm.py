...
## Variables
DUMMY_AI_CTRL = 1    # Enable dummy AI control on the slicing
...
def dummy_data_driven_ctrl(slice_dlth_mapping, ctrl_sock):
    ...
    # Send first control
    control_buf = trigger_slicing_control(sst=sst5, sd=sd5, min_ration=0, max_ration=10)
    ...
    # Send second control
    control_buf = trigger_slicing_control(sst=sst95, sd=sd95, min_ration=0, max_ration=90)
    send_socket(ctrl_sock, control_buf)
